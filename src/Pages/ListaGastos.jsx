          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {gastos.length > 0 ? (
                  gastos.map((gasto) => (
                    <tr key={gasto.gasto_id} className="hover:bg-gray-50 transition-colors duration-150">
      ...
      {modalVisible && selectedGasto && (
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl mx-auto relative" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 rounded-t-2xl px-6 py-5 sticky top-0 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">Detalle del Gasto</h2>
                    <p className="text-amber-100 text-sm mt-1">Información completa del registro</p>
                  </div>
                </div>
                <button
                  onClick={closeModal}
                  className="text-white/80 hover:text-white transition-all p-2 hover:bg-white/20 rounded-xl backdrop-blur-sm"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
            ...
            <div className="p-6">
              {/* Tarjeta principal con descripción y monto */}
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 mb-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex-1">
                    <p className="text-sm text-gray-500 mb-1">Descripción del gasto</p>
                    <h3 className="text-xl font-bold text-gray-900">{selectedGasto.descripcion}</h3>
                    <div className="flex items-center space-x-2 mt-2">
                      <Hash className="w-4 h-4 text-gray-400" />
                      <span className="text-sm text-gray-500">ID: #{selectedGasto.gasto_id}</span>
                    </div>
                  </div>
                  <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-3 rounded-xl shadow-lg text-center">
                    <p className="text-xs text-emerald-100 mb-1">Monto total</p>
                    <p className="text-2xl font-bold">S/.{Number(selectedGasto.monto).toFixed(2)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-gray-900 mt-1">{selectedGasto.categoria_nombre || "Sin categoría"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-gray-900 mt-1">{selectedGasto.periodo_nombre || "No especificado"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Fecha del gasto</p>
                      <p className="text-lg font-bold text-gray-900 mt-1">{formatearFecha(selectedGasto.fecha_gasto)}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-gray-900 mt-1">{selectedGasto.TipoPago || "No especificado"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow md:col-span-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Empleado responsable</p>
                      <p className="text-lg font-bold text-gray-900 mt-1">
                        {selectedGasto.empleado_nombre || selectedGasto.empleado || "No asignado"}
                      </p>
                      {selectedGasto.empleado_cargo && (
                        <p className="text-sm text-gray-500 mt-1">{selectedGasto.empleado_cargo}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200 overflow-hidden">
                  <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 px-5 py-3 border-b border-amber-200">
                    <div className="flex items-center space-x-2">
                      ...
                      <h4 className="font-semibold text-amber-900">Observaciones adicionales</h4>
                    </div>
                  </div>
                  <div className="p-5">
                    {selectedGasto.observaciones ? (
                      ...
                      <div className="text-center py-6">
                        ...
                        <p className="text-gray-500">No hay observaciones registradas para este gasto</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-5">
                <h4 className="text-white text-sm font-semibold uppercase tracking-wide mb-3">Información del registro</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <p className="text-gray-400 text-xs">Registrado por</p>
                    <p className="text-white font-medium mt-1">{selectedGasto.usuario || "Sistema"}</p>
                  </div>
                  <div>
              ...
              <div className="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-lg hover:shadow-lg transition-all font-medium flex items-center space-x-2"
                >
                  <Edit className="w-4 h-4" />
