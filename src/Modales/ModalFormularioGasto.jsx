...
export default function ModalFormularioGasto({ gastoSeleccionado, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = gastoSeleccionado 
        ? `${BACKEND_URL}/api/gastos/${gastoSeleccionado.gasto_id}`
        : `${BACKEND_URL}/api/gastos`;
  ...
  return (
    // ✅ BACKDROP - z-index extremadamente alto para estar por encima de todo
    <div 
      ...
      onClick={(e) => {
        // Cerrar si se clickea fuera del contenido del modal
    ...
    >
      ...
      >
        <div className="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 px-4 py-4 sticky top-0 z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-white rounded-lg p-3 border border-gray-200">
                      ...
                      <p className="text-lg font-bold text-gray-800">
                        S/. {formatDisplay(formData.monto)}
                      </p>
                    </div>

                    <div className={`bg-white rounded-lg p-3 border ${
                      montosCoinciden ? 'border-green-200' : 'border-red-200'
                    }`}>
                      <div className="flex items-center space-x-2 mb-2">
                  ...
                  {!montosCoinciden && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                      <p className="text-sm text-red-600 font-medium">
                        ⚠️ Los montos no coinciden. Diferencia: S/. {formatDisplay(diferencia)}
                      </p>
                    </div>
                  )}
