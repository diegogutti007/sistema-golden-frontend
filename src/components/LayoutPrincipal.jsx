...
const LayoutPrincipal = ({ children, usuario, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-white">
      {/* Fondo decorativo - con pointer-events: none para no bloquear clicks */}
      ...
      {/* Header - z-index reducido para no competir con modales */}
      ...
      <div className="pt-16 min-h-screen">
        {/* Menu Secundario - z-index menor que los modales */}
        <MenuSecundario 
        ...
        {/* Main content - sin backdrop que interfiera */}
        <main className={`
        ...
        `}>
          <div className="w-full h-full flex justify-center">
            <div className={`
              ...
              ${getPadding()}
            `}>
              {/* Eliminado el bg-white/95 backdrop-blur-sm que estaba causando el problema */}
      ...
      {/* Footer - z-index bajo */}
      <footer className="bg-white/80 backdrop-blur-sm border-t border-gray-200 py-5 text-center text-gray-500 text-xs relative z-10">
